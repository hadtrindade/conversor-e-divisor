...
from conversor_divisor import __author__, __version__, ui_functions
...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.button_source_file.clicked.connect(
            lambda: ui_functions.get_media_convert(self)
        )
        self.button_source_file_split.clicked.connect(
            lambda: ui_functions.get_media_split(self)
        )
        # button_output
        self.button_output_file.clicked.connect(
            lambda: ui_functions.get_output_convert(self)
        )
        self.button_output_file_split.clicked.connect(
            lambda: ui_functions.get_output_split(self)
        )
        # button_open_folder
        self.button_open_folder.clicked.connect(
            lambda: ui_functions.open_output_convert(self)
        )
        self.button_open_folder_split.clicked.connect(
            lambda: ui_functions.open_output_split(self)
        )
